...
exports.TEMPLATE_ENTITY_BLUEPRINTS = void 0;
exports.findBlueprintForSlug = findBlueprintForSlug;
const field = (name, label, type, order, extra) => ({
    name,
    label,
    type,
...
exports.TEMPLATE_ENTITY_BLUEPRINTS = [
    {
        slug: 'employees',
        aliases: ['employee'],
        definition: {
...
function findBlueprintForSlug(slug) {
    const normalized = slug.trim().toLowerCase();
    return exports.TEMPLATE_ENTITY_BLUEPRINTS.find((bp) => bp.slug === normalized ||
        bp.aliases.some((a) => a.toLowerCase() === normalized));
}
//# sourceMappingURL=template-entity-blueprints.js.map